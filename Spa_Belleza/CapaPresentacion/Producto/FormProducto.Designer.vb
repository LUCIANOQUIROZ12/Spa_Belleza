...
Partial Class FormProducto
    ...
    Private Sub InitializeComponent()
        ...
        PanelSuperior.Size = New Size(1370, 65)
        ...
        PanelContenido.Size = New Size(1370, 684)
        PanelContenido.TabIndex = 2
        ' 
        ' PictureBox4
        ' 
        PictureBox4.Image = CType(resources.GetObject("PictureBox4.Image"), Image)
        PictureBox4.Location = New Point(671, 122)
        ...
        DataGridView1.Location = New Point(105, 176)
        DataGridView1.Name = "DataGridView1"
        DataGridView1.Size = New Size(884, 340)
        DataGridView1.TabIndex = 3
        ' 
        ' txtBusqueda
        ' 
        txtBusqueda.Font = New Font("Segoe UI", 9.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        txtBusqueda.Location = New Point(705, 126)
        ...
        BtnRegistrar.Location = New Point(951, 122)
        BtnRegistrar.Name = "BtnRegistrar"
        BtnRegistrar.Size = New Size(143, 35)
        BtnRegistrar.TabIndex = 1
        BtnRegistrar.Text = "Agregar Producto"
